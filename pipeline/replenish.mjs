...
1. 구체적인 상황을 담을 것. 큰 주제는 대형 포털과 취업 사이트가 이미 점유하고 있어 이길 수 없습니다.
   - 나쁨: "실업급여 조건", "연말정산 방법", "퇴직금 계산"
   - 좋음: "권고사직인데 실업급여 받을 수 있나", "실업급여 받는 중에 단기 알바하면 어떻게 되나", "퇴직 직전에 받은 성과급이 퇴직금에 포함되나"
2. 검색량이 적어도 괜찮습니다. 월 수백 회라도 실제로 상위에 노출되는 편이, 월 수만 회짜리에서 10페이지 밖에 있는 것보다 낫습니다.
3. 대형 사이트가 다루지 않는 각도일 것. 그들은 개괄만 씁니다. 예외 상황, 헷갈리는 경계, 사람마다 답이 갈리는 지점이 우리 자리입니다.
4. 한 글에 질문 하나만. "총정리", "모음", "완벽 가이드" 형태는 만들지 마세요.
5. 이미 있는 주제와 겹치지 않을 것.

title은 검색창에 칠 법한 말에 가깝게 쓰세요. angle에는 무엇을 설명할지 구체적으로 쓰되, 특히 "어떤 경우에 답이 달라지는지"를 담으세요. 제목을 풀어 쓴 문장이 아니라 글의 뼈대가 되어야 합니다.`;
